      ...
      body: Consumer<BookingViewModel>(
        builder: (context, bookingViewModel, child) {
          ...
          if (nuevaSeleccion.isNotEmpty) {
            bool yaExiste = bookingViewModel.upcomingBookings.any(
              (b) => b.businessName == nuevaSeleccion,
            );
            bool yaEstaEnPasados = bookingViewModel.pastBookings.any(
              (b) => b.businessName == nuevaSeleccion,
            );
                ...
                child: _activeTab == 'Próximos'
                    ? (bookingViewModel.upcomingBookings.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemCount:
                                  bookingViewModel.upcomingBookings.length,
                              itemBuilder: (context, index) {
                                return _buildBookingCard(
                                  bookingViewModel.upcomingBookings[index],
                                  bookingViewModel,
                                );
                              },
                            ))
                    : (bookingViewModel.pastBookings.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return _buildPastBookingCard(
                                  bookingViewModel.pastBookings[index],
                                  bookingViewModel,
                                );
                              },
                            )),
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        if (fechaStr != null)
                          cardSetState(() => booking.date = fechaStr);
                      },
                      child: Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 12,
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(14),
                          border: Border.all(
                            color: booking.date == 'Seleccionar Fecha'
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        if (horaStr != null)
                          cardSetState(() => booking.time = horaStr);
                      },
                      child: Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 12,
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(14),
                          border: Border.all(
                            color: booking.time == 'Seleccionar Hora'
                                ? const Color(0xFFE2E8F0)
                                : const Color(0xFF0061FF).withOpacity(0.3),
                          ),
                        ),
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () {
                        if (booking.date == 'Seleccionar Fecha' ||
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () =>
                          _mostrarModalCancelacion(context, booking, viewModel),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ReasonCancelView(
